    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telegram_username', models.CharField(blank=True, max_length=256, null=True, verbose_name='Телеграм логин')),
                ('is_active', models.BooleanField(default=True, help_text='Если установлен, то пользователь имеет доступа к боту', verbose_name='Активный пользователь')),
